...
import 'package:smart_clock_widget/utils/constants.dart';
import 'package:smart_clock_widget/widgets/pixabay/pixabay_api_state.dart';
import 'package:win_toast/win_toast.dart';
import 'package:window_manager/window_manager.dart';
import 'package:provider/provider.dart';
import 'package:smart_clock_widget/pages/home/home_page.dart';
...
Future<void> main() async {
  ...
  CurrentMode = WidgetsBinding.instance!.window.platformBrightness;
  await hotKeyManager.unregisterAll();
  await SystemTheme.accentColor.load();
  await WinToast.instance().initialize(
      aumId: '48434ZodipaSoftware.SmartClockWidget',
      displayName: 'Smart Clock Widget',
      iconPath: '',
