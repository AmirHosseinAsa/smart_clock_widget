...
import 'package:smart_clock_widget/pages/watchBackground/background_image_item.dart';
import 'package:smart_clock_widget/pages/watchBackground/background_item.dart';
import 'package:smart_clock_widget/widgets/pixabay/pixabay_categories.dart';
...
import 'package:smart_clock_widget/widgets/waves.dart';
                    ...
                    builder: (_) => PixabayCategories(
                      onSelectImage: (image) async {
                        ...
                        if (imageUrl.isNotEmpty) {
                          var localPath =
                              '${(await getApplicationDocumentsDirectory()).path}/SmartClockWidget/Wallpapers/${Uri.parse(imageUrl).pathSegments.last}';
